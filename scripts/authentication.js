            ...
            fetch(`http://127.0.0.1:8000/api/register/`, {
                ...
                .then(function (response) {
                    ...
                    setTimeout(()=>{
                        ...
                        document.querySelector('.start-container').innerHTML += '<h2 id="text" style="opacity:0;margin-top:20px;animation:MainBG .5s linear forwards">You have successfully registered</h2>'
                        main()
                    },500)
                }else{
